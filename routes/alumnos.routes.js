...
/* listar alumnos + docente por grado (si existe) */
router.get('/', async (req, res) => {
  try {
    ...
    if (activoParam !== undefined) { clauses.push(`a.activo = $${i}`); values.push(String(activoParam).toLowerCase()==='true'); i++; }
...
router.get('/:id/qr', async (req, res) => {
  try {
    ...
    console.error('GET /alumnos/:id/qr', e);
